...
import ModalBarberoServicio from './ModalBarberoServicio';
import ModalConfirmarEliminar from '../compartido/ModalConfirmarEliminar';

export default function BarberoServicios({ usuarioId }) {
    ...
    <section className="bg-zinc-900 rounded-2xl border border-zinc-800 p-6 space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-zinc-400">Servicios que ofreces a los clientes.</p>
        </div>
        <button
          onClick={abrirNuevo}
      ...
      {cargando ? (
        ...
        <p className="text-sm text-zinc-500">No tienes servicios registrados aún.</p>
      ) : (
